...
function Homepage() {
  useEffect(() => {
    ...
    const leftAnimation = gsap.to(leftWave, {
      x: 12,
      y: -6,
      rotation: 2,
      duration: 3.5,
    ...
    const rightAnimation = gsap.to(rightWave, {
      x: -12,
      y: -6,
      rotation: -2,
      duration: 4,
...
if (fishContainer) {
  ...
  fishes.forEach((fish, index) => {
    ...
    /* =====================================================
       ARTISAN CONTENT SCROLL
    ===================================================== */

    const artisanContent = document.querySelector(
      ".artisan-content"
    );
    ...
    if (artisanContent) {
      const animation = gsap.from(artisanContent, {
        y: 100,
        opacity: 0,
        duration: 1.1,
        ease: "power3.out",
    ...
    const philosophy = document.querySelector(
      ".philosophy-inner"
    );

    if (philosophy) {
      const animation = gsap.from(philosophy, {
        y: 90,
        opacity: 0,
        duration: 1.2,
        ease: "power3.out",
    ...
    const archiveHeader = document.querySelector(
      ".archive-header"
    );

    if (archiveHeader) {
      const animation = gsap.from(archiveHeader, {
        y: 70,
        opacity: 0,
        duration: 1,
        ease: "power3.out",
    ...
    const commission = document.querySelector(
      ".commission-inner"
    );

    if (commission) {
      const animation = gsap.from(commission, {
        y: 100,
        opacity: 0,
        duration: 1.2,
        ease: "power3.out",
    ...
    return () => {
      ...
      fishAnimations.forEach((animation) => {
        animation.kill();
      });
    ...
    <div className="home-page">
      ...
      <section className="hero-section">
        ...
        <p className="hero-description">
          Crafting digital experiences with the patience and
          structural elegance of Edo period masters. A portfolio
          shaped by the timeless aesthetics of Ukiyo-e (浮世絵).
        </p>
      ...
      <section className="ocean-section">
        ...
        <section className="artisan-section">
          ...
          <div className="artisan-content">
            ...
            <p>
          My journey as a FullStack Developer has been shaped by building
          practical web applications across PHP and JavaScript ecosystems.
          I work with Laravel, PHP, JavaScript, React, Node.js, MySQL,
          and MongoDB, focusing on building clean, reliable, and
          maintainable digital experiences.
        </p>

        <p>
          From backend APIs and database-driven applications to modern
          React interfaces, I enjoy working across the full development
          stack. My experience has taught me to value strong fundamentals,
          thoughtful architecture, and simple solutions that perform well
          in the real world.
        </p>
        ...
        <section className="philosophy-section">
          ...
          <div className="philosophy-inner">
            ...
            <p>
              It is the careful arrangement of every detail.
              Every interface should feel deliberate, balanced,
              and quietly alive.
            </p>
        ...
        >
          ...
          <div className="commission-inner">
            ...
            <p>
              Currently accepting inquiries for digital product
              design, aesthetic direction, and thoughtful
              web experiences.
            </p>
